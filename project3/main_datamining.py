...
class main():
    ...
    # Step 5
    def step5(self):
        #create an object from Differential_Evolution class to use all DE functions in calculating best and optimum fitness and errors
        self.Diff = Population_Process.Differential_Evolution(self.number, self.data)
        # create initial population
        self.Diff.initial_population_total()
    ...
    def step6(self):
        for j in range(10000):
            ...
            self.Diff.PrintModelResults(j)
            #create next population
            self.Diff.create_next_population()
        self.Diff.remove_redundunt_from_file()
